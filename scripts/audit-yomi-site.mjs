...
const pages = [
  { file: 'yomi/index.html', lang: 'en', canonical: 'https://rikaidev.github.io/yomi/', guide: false, family: 'home' },
  { file: 'yomi/zh-tw/index.html', lang: 'zh-Hant-TW', canonical: 'https://rikaidev.github.io/yomi/zh-tw/', guide: false, family: 'home' },
...
for (const page of pages) {
  ...
  if (page.guide) {
    ...
    homeStructures.push({ file: page.file, structure });
  }
}
...
if (homeStructures.length === 2 && JSON.stringify(homeStructures[0].structure) !== JSON.stringify(homeStructures[1].structure)) {
  errors.push(`${homeStructures[0].file} and ${homeStructures[1].file}: localized home structures have drifted`);
}
